...
<header class="header-area header-sticky" xframeoptions="SAMEORIGIN" frameancestors="'self'">
    ...
    <div class="page-heading-about">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>SHOW WHAT I HAVE</h2>
                    <span>August 24, 2024 in ICE BSD CITY HALL 5-6</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    <div class="right-content">
                        <div class="about-map-image">
                            <img src="../images/bsd.png" alt="location">
                        </div>
                        <div class="down-content">
                            <h4>SHOW WHAT I HAVE</h4>
                            <ul>
                                <li>August 24 Saturday</li>
                                <li>07:00 PM</li>
                            </ul>
                            <span><i class="fa fa-ticket"></i> Tickets Starting From IDR 1.225.000</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p>
                    Siap untuk Love Dive? Saksikan grup K-pop ikonik, IVE ke Jakarta untuk konser perdana mereka, "IVE THE 1ST WORLD TOUR <SHOW WHAT i HAVE> IN JAKARTA"!
Konser akan berlangsung pada 24 Agustus 2024 di ICE BSD City Hall 5-6.
                    </p>
                    <h4>Information</h4>
                    <ul>
                        <li>* General Sales dimulai pada 28 Desember 2023 pukul 14.00 WIB</li>
                    ...
                    <div class="next-shows">
                        ...
                        <ul>
                            <li>
                                ...
                                <span>March 2 Saturday<br>06:30 PM</span>
                            ...
                            <li>
                                <h5>THE 38th GOLDEN DISC AWARD (GDA) 2024</h5>
                                <span>January 6 Saturday<br>06:30 PM</span>
                                <div class="icon-button">
                                    <a href="ticket-gda.php">
                                        <i class="fa fa-shopping-cart"></i>
                                    </a>
                                </div>
                            </li>
