...
<header class="header-area header-sticky" xframeoptions="SAMEORIGIN" frameancestors="'self'">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="left-image">
                        <img src="../images/gda-seat.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        ...
                        <ul>
                            <li><i class="fa fa-clock-o"></i> Saturday 06:30 PM</li>
                            <li><i class="fa fa-map-marker"></i>Jakarta International Stadium, Kapasitas 35.000</li>
                        </ul>
                        <div class="quantity-content" data-category-id="1">
                          <div class="left-content">
                            <h6 id="category-name-1">CAT 6 (SEATING)</h6>
                            <p id="ticket-price-1">Rp. 1.325.000</p>
                          </div>
                          <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="2">
                          <div class="left-content">
                            <h6 id="category-name-2">CAT 5 (SEATING)</h6>
                            <p id="ticket-price-2">Rp. 1.775.000</p>
                          </div>
                          <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="3">
                          <div class="left-content">
                            <h6 id="category-name-3">CAT 4 (SEATING)</h6>
                            <p id="ticket-price-3">Rp. 2.425.000</p>
                          </div>
                          <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="4">
                          <div class="left-content">
                            <h6 id="category-name-4">CAT 3 (SEATING)</h6>
                            <p id="ticket-price-4">Rp. 2.725.000</p>
                          </div>
                          <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="5">
                          <div class="left-content">
                            <h6 id="category-name-5">CAT 2 (SEATING)</h6>
                            <p id="ticket-price-5">Rp. 3.575.000</p>
                          </div>
                          <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="6">
                          <div class="left-content">
                            <h6 id="category-name-6">CAT 1 (SEATING)</h6>
                            <p id="ticket-price-6">Rp. 4.025.000</p>
                          </div>
                          <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="7">
                          <div class="left-content">
                            <h6 id="category-name-7">FESTIVAL B (SEATING)</h6>
                            <p id="ticket-price-7">Rp. 3.825.000</p>
                          </div>
                          <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="8">
                          <div class="left-content">
                            <h6 id="category-name-8">FESTIVAL A (SEATING)</h6>
                            <p id="ticket-price-8">Rp. 4.025.000</p>
                          </div>
                          <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="9">
                          <div class="left-content">
                            <h6 id="category-name-9">VIP (SSTANDING)</h6>
                            <p id="ticket-price-9">Rp. 4.025.000</p>
                          </div>
                          <div class="right-content">
    ...
    const categories = {
      ...
      5: "CAT 2 (SEATING) - GDA",
      6: "CAT 1 (SEATING) - GDA",
      7: "FESTIVAL A (SEATING) - GDA",
      8: "FESTIVAL B (SEATING) - GDA",
      9: "VIP (STANDING) - GDA",
    };
  ...
  function getTicketPrice(categoryId) {
    const prices = {
      1: "1325000", // Removed formatting for calculations
      2: "1775000",
      3: "2425000",
      4: "2725000",
      5: "3575000",
