...
<header class="header-area header-sticky" xframeoptions="SAMEORIGIN" frameancestors="'self'">
    ...
    <div class="page-heading-about">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>BREAK THE BRAKE</h2>
                    <span>March 2, 2024 in The Kasablanka Hall</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="left-image">
                        <img src="../images/btb-xd.webp" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <div class="about-map-image">
                            <img src="../images/kasablanka.png" alt="location">
                        </div>
                        <div class="down-content">
                            <h4>BREAK THE BRAKE</h4>
                            <ul>
                                <li>March 2 Saturday</li>
                                <li>07:00 PM</li>
                            </ul>
                            <span><i class="fa fa-ticket"></i> Tickets Starting From IDR 1.125.000</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    ...
                    <p>
                    Nonton langsung band rock ikonik dari Korea Selatan, XDINARY HEROES lewat tur mereka, "XDINARY HEROES (Break the Brake) WORLD TOUR IN JAKARTA”!
Konser akan berlangsung di The Kasablanka Hall, Jakarta pada 2 Maret 2024.
                    </p>
                    <h4>Information</h4>
                    <ul>
