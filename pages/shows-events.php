...
Konser akan berlangsung pada 24 Agustus 2024 di ICE BSD City Hall 5-6.</p>
                                                                    <div class="main-dark-button"><a href="detail-ive.php">Discover More</a></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="thumb">
...
Konser akan berlangsung di The Kasablanka Hall, Jakarta pada 2 Maret 2024.</p>
                                                                    <div class="main-dark-button"><a href="detail-xd.php">Discover More</a></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="thumb">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="left-content">
                                                                    ...
                                                                    <p>Golden Disc Awards ke-38 dengan Bank Mandiri akan membawa deretan bintang musik Korea, artis solo, dan bahkan bintang film sebagai pembawa acara dan presenter ke Indonesia, memberikan penggemar pertunjukan selama 4 jam yang akan menjadi pengalaman tak terlupakan.</p>
                                                                    <div class="main-dark-button"><a href="detail-gda.php">Discover More</a></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="thumb">
