...
<header class="header-area header-sticky" xframeoptions="SAMEORIGIN" frameancestors="'self'">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="left-image">
                        <img src="../images/btb-seat.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-map-marker"></i>The Kasablanka Hall, Kapasitas 5.500</li>
                        </ul>
                        <div class="quantity-content" data-category-id="1">
                            <div class="left-content">
                                <h6 id="category-name-1">YELLOW A</h6>
                                <p id="ticket-price-1">Rp. 1.125.000</p>
                            </div>
                            <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="2">
                            <div class="left-content">
                                <h6 id="category-name-2">YELLOW B</h6>
                                <p id="ticket-price-2">Rp. 1.125.000</p>
                            </div>
                            <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="3">
                            <div class="left-content">
                                <h6 id="category-name-3">GREEN</h6>
                                <p id="ticket-price-3">Rp. 1.725.000</p>
                            </div>
                            <div class="right-content">
                        ...
                        <div class="quantity-content" data-category-id="4">
                            <div class="left-content">
                                <h6 id="category-name-4">BLUE (SOUNDCHECK)</h6>
                                <p id="ticket-price-4">Rp. 2.425.000</p>
                            </div>
                            <div class="right-content">
  ...
  function getTicketPrice(categoryId) {
    const prices = {
      1: "1125000", // Removed formatting for calculations
      2: "1125000",
      3: "1725000",
      4: "2425000",
    };
